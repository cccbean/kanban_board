...
const Header = ({ title, projects, setProjects, theme, themeSwitcher }: HeaderProps) => {
	...
	return (
		<header className="relative flex justify-between bg-slate-50 shadow-sm shadow-slate-50 dark:bg-zinc-800 dark:text-zinc-300 dark:shadow-zinc-800">
			...
			<dialog
				className="h-screen max-h-none w-1/3 translate-x-[101%] dark:bg-zinc-800 dark:text-zinc-300"
				ref={menuModalRef}
			>
					...
					<ul className="flex flex-col">
						{projects.map((project) => {
							return (
								<li
									key={project}
									className="flex border-b border-zinc-800 last:border-none dark:border-zinc-300"
								>
									<Link
